...
export default function Authenticate(props) {
      ...
      (response) => {
        if (response.ok) {
          ...
          if (result.detail === "exists") {
            setErrorMsg(
              "An account with this Email ID already exists. Try Logging in."
            );
            setLoading(false);
  ...
  const movePage = (emailVerified) => {
    ...
    } else if (emailVerified) window.location.href = getRedirectUrl();
  };
      ...
      {props.login ? (
        ...
        <div className="min-vh-100 d-flex justify-content-center align-items-center">
          <div className="col-10 col-sm-9 col-md-7 col-xl-5 row justify-content-center my-5">
            <Link
              to={routes.home}
              className="text-center text-light text-decoration-none fw-bold fs-1 smooth-transition"
            >
              BotHub.in
            </Link>
            <div className="text-center fs-5 mb-4">
              {props.page === "login" ? "Login to your Account" : "Sign Up"}
            </div>
            <div className="card col-12 col-md-10 m-2">
              <div className="card-body w-100">
                <Form
                  className="mt-5 mb-4 mx-3"
                  onSubmit={() => {
                ...
                >
                  ...
                  <Col className="text-center text-danger">{errorMsg}</Col>
                ...
                <Col className="text-center mb-4">
                  <div className="fs-6">
                    Or, {props.page === "login" ? "Login" : "Sign Up"} with
                  </div>
                  <Button
                    variant="secondary"
        ...
        <div className="card col-12 col-md-10 m-2">
          <div className="card-body w-100">
            ...
            >
              ...
              <Col className="text-center text-danger">{resultMsg}</Col>

              <Col className="text-center mt-4">
                <Button
                  variant={btnState === "not-sent" ? "secondary" : "success"}
