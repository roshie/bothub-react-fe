              ...
              <Form className="mt-5 mb-4 mx-3">
                <div className="row">
                  <FloatingLabel
                    ...
                    label="Full Name"
                  >
                    <Form.Control className="bg-primary border-primary text-light" required type="text" placeholder="Joe Dohn" />
                  </FloatingLabel>
                  <FloatingLabel
                    controlId="floatingInput"
                    className="mb-3 col-md-6 text-light"
                    label="Mobile Number"
                  >
                    <Form.Control className="bg-primary border-primary text-light" required type="tel" placeholder="9080691390" />
                  </FloatingLabel>
                </div>
                <FloatingLabel
                  controlId="floatingInput"
                  ...
                  label="Email"
                >
                  <Form.Control className="bg-primary border-primary text-light" required type="email" placeholder="johndoe@gmail.com" />
                </FloatingLabel>
                <FloatingLabel
                  ...
                  label="Your Ideas"
                >
                  <Form.Control className="bg-primary border-primary text-light" required as="textarea" style={{height:'100px'}} placeholder="I have a Brilliant Idea..." />
                </FloatingLabel>
                <div className="text-center">
                  <a href="mailto:bothub.zue@gmail.com" className="btn btn-secondary fw-bold">
                      Submit
                  </a>
                </div>
              </Form>
