...
export default function Error500(props) {
    ...
    useEffect(() => { document.title = "Something went wrong. | Bothub" })
    return (
        <div className="min-vh-100 d-flex justify-content-center align-items-center">
            ...
            <div className="card bg-info h-100 mx-3">
                <div className="card-body p-5">
                    ...
                    <h5>Please try again later<Link to={routes.home} className="text-decoration-none text-secondary"> Go To Home</Link></h5>
